...
const App: React.FC = () => {
  ...
  return (
    <div className="w-full h-screen relative bg-[#050a0e] overflow-hidden touch-none">
      {!isGameStarted ? (
        <div className="absolute inset-0 z-50 flex items-center justify-center bg-black/95">
          <div className="text-center p-10 bg-zinc-900 rounded-[3.5rem] border border-green-500/30 max-w-xs shadow-2xl">
            ...
            <p className="text-zinc-500 text-[10px] mb-10 uppercase tracking-[0.3em] font-bold">Engine 2.0 (High-Fi)</p>
            <button 
        ...
        <>
          <Canvas 
            shadows 
            dpr={[1, 1.2]} // Limite reduzido para estabilidade WebGL
            gl={{ 
              antialias: false,
              powerPreference: "default", // Evita crash em algumas GPUs mobile
